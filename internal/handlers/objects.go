...
func ListObjects(repo repository.Repository) gin.HandlerFunc {
	return func(c *gin.Context) {
		projects, err := repo.ListProjectsLegacy(c.Request.Context())
		if err != nil {
...
func CreateObject(repo repository.Repository) gin.HandlerFunc {
	return func(c *gin.Context) {
		...
		if err := repo.CreateProjectLegacy(c.Request.Context(), &p); err != nil {
			c.JSON(http.StatusInternalServerError, gin.H{"error": err.Error()})
			return
		}
...
func GetObject(repo repository.Repository) gin.HandlerFunc {
	return func(c *gin.Context) {
		id := c.Param("id")
		project, err := repo.GetProjectByIDLegacy(c.Request.Context(), id)
		if err != nil {
...
func UpdateObject(repo repository.Repository) gin.HandlerFunc {
	return func(c *gin.Context) {
		...
		existing, err := repo.GetProjectByIDLegacy(c.Request.Context(), id)
		if err != nil {
		...
		if err := repo.UpdateProjectLegacy(c.Request.Context(), existing); err != nil {
			c.JSON(http.StatusInternalServerError, gin.H{"error": err.Error()})
			return
		}
...
func DeleteObject(repo repository.Repository) gin.HandlerFunc {
	return func(c *gin.Context) {
		...
		if err := repo.DeleteProjectLegacy(c.Request.Context(), id); err != nil {
			c.JSON(http.StatusInternalServerError, gin.H{"error": err.Error()})
			return
		}
